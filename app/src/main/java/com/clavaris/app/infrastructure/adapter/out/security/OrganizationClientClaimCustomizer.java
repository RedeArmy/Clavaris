...
@Component
public class OrganizationClientClaimCustomizer
   ...
   */
  public static final String ORGANIZATION_ID_CLAIM = "organization_id";

  private final OrganizationClientRepository organizationClients;

  public OrganizationClientClaimCustomizer(final OrganizationClientRepository organizationClients) {
