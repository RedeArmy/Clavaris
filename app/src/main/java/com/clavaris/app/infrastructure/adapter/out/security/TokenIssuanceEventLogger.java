 ...
 */
@Component
public class TokenIssuanceEventLogger implements OAuth2TokenCustomizer<JwtEncodingContext> {
  ...
  public TokenIssuanceEventLogger(final SecurityMetricsRecorder metrics) {
