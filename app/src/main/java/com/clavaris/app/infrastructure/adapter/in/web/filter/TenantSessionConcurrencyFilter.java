...
import com.clavaris.app.infrastructure.adapter.out.security.InvalidateAndContinueSessionExpiredStrategy;
 ...
 */
public final class TenantSessionConcurrencyFilter extends OncePerRequestFilter {
  ...
  public TenantSessionConcurrencyFilter(final SessionRegistry sessionRegistry) {
    super();
