 ...
 */
public final class OrganizationScopedJwkSource implements JWKSource<SecurityContext> {

  private final OrganizationSigningKeyMaterialFactory keyMaterial;

  public OrganizationScopedJwkSource(final OrganizationSigningKeyMaterialFactory keyMaterial) {
