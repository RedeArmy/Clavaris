...
public final class RateLimitIdentifiers {
   ...
   */
  public static String emailFormField(final HttpServletRequest request) {
   ...
   */
  public static String oauthClientId(final HttpServletRequest request) {
  ...
  public static String authenticatedPlatformAccountId(final HttpServletRequest request) {
   ...
   */
  @SuppressWarnings("java:S1172")
  public static String authenticatedPlatformClientId(final HttpServletRequest request) {
    return currentAuthenticationName();
  }
   ...
   */
  @SuppressWarnings("java:S1172")
  public static String authenticatedAccountId(final HttpServletRequest request) {
    return currentAuthenticationName();
  }
}
