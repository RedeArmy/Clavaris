 ...
 */
public final class SessionDeviceAttributes {

  public static final String USER_AGENT = "clavaris.device.userAgent";

  public static final String SOURCE_IP = "clavaris.device.sourceIp";
