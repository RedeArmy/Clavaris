...
@Service
public class GitHubVerifiedEmailUserService
   ...
   */
  public static final String VERIFIED_EMAIL_ATTRIBUTE = "clavaris_github_verified_email";
  ...
  @Autowired
  public GitHubVerifiedEmailUserService(
