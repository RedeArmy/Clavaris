 ...
 */
@Component
public class TokenRevocationEventLogger implements AuthenticationSuccessHandler {
  ...
  public TokenRevocationEventLogger(final SecurityMetricsRecorder metrics) {
