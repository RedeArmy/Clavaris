...
class ContentSecurityPolicyHeaderWriterTest {
  ...
  @Test
  void aConsentPathThatIsNotHtmlNeverGetsEitherPolicy() {
  ...
  // Sanity: both policies are genuinely different strings, or the "two policies" design claim
  // this class's own Javadoc makes would be silently false.
  @Test
  void theTwoPoliciesAreActuallyDifferent() {
    HttpServletRequest strictRequest = requestWithUri(ORG_LOGIN_PATH);
