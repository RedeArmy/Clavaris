 ...
 * or repository directly (CLAUDE.md §7.2's module-independence rule applied at the module-graph
 * level, same convention {@code SigningKeyProvisioner} follows on the organization-module side).
 * Implemented in {@code app}, the one module allowed to depend on both, by delegating to
 * organization-module's own {@code OrganizationRepository.existsById}.
 */
@FunctionalInterface
