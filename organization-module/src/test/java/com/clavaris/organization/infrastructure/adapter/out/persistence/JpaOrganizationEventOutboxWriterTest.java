 ...
 * reaches the {@link EntityManager} — the one branch {@code DeleteOrganizationIntegrationTest}'s
 * own real-Postgres happy path can't exercise (it never hands this writer a payload Jackson can't
 * serialize).
 */
class JpaOrganizationEventOutboxWriterTest {

  @Test
  void wrapsASerializationFailureInAnIllegalStateExceptionWithoutTouchingTheEntityManager() {
    ...
    JpaOrganizationEventOutboxWriter writer =
        new JpaOrganizationEventOutboxWriter(new ObjectMapper(), entityManager);
