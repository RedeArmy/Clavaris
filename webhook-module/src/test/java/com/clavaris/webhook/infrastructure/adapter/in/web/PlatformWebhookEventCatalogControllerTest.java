...
class PlatformWebhookEventCatalogControllerTest {
  ...
  void setUp() {
    ...
    mockMvc =
        MockMvcBuilders.standaloneSetup(
                new PlatformWebhookEventCatalogController(
                    organizationResolver, currentPlatformAccount))
  ...
  private String basePath() {
    return "/platform/dashboard/organizations/"
        + organizationId
        + "/webhook-endpoints/event-catalog";
  }

  @Test
  void showsEveryKnownEventTypeGroupedByCategory() throws Exception {
    mockMvc
        ...
        .andExpect(content().string(containsString("workspace_membership.role_changed")));
  }
