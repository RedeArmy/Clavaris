 ...
 * organization-module}, ADR-0010) — an opaque UUID only, per the hexagonal rule (CLAUDE.md §7.2):
 * no module holds a live object reference across the module boundary.
 */
